...
import { FiHome, FiFileText, FiPlusSquare, FiEdit, FiMail, FiUser, FiFile } from "react-icons/fi";
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                icon: <FiPlusSquare className="text-sm" />,
            },
            {
                id: 4,
                name: "Resume Editor",
    ...
    },
    {
        ...
        items: [
            ...
            },
            {
                ...
                path: "/dashboard/cover-letter-builder",
                icon: <FiPlusSquare className="text-sm" />,
            },
            {
                name: "Cover Letter Editor",
                path: "/dashboard/cover-letter-editor",
                icon: <FiEdit className="text-sm" />,
            },
        ],
    },
