...
const OurService = () => {
    return (
        <motion.div className="bg-gradient-to-br  from-emerald-500 to-cyan-900 via-cyan-800 animate-gradient sm:items-center  py-32 border-box w-full px-16  md:px-20 lg:px-40">
            <div className="max-w-full mx-auto flex h-full justify-between items-center gap-18 flex-col-reverse md:flex-row lg:flex-row ">
                <motion.div
                ...
                >
                    <h1 className="text-3xl font-bold leading-relaxed text-center md:text-left">
